                        ...
                        <div class="item">
                            <div class="products">
                                ...
                                <div class="product-info text-left m-t-20">
                                    <h3 class="name"><a href="{{ url('product/detail/'.$item->id.'/'.$item->product_slug_en) }}">@if(session()->get('language')
                                            == 'urdu')
                                    ...
                                    @else
                                    <div class="product-price"> <span class="price"> ${{ $item->discount_price }}
                                        </span> <span class="price-before-discount">${{ $item->selling_price }}</span>
                                    </div>
                                    @endif
                                    <!-- /.product-price -->
                                            ...
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ url('product/detail/'.$item->id.'/'.$item->product_slug_en) }}"> <img src="{{ asset($item->product_thumbnail) }}"
                                                                    alt=""> </a> </div>
                                                        <!-- /.image -->
                                    ...
                                    <div class="product">
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ url('product/detail/'.$item->id.'/'.$item->product_slug_en) }}"> <img
