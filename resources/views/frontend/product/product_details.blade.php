...
{{ $product->product_name_ur }} @else {{ $product->product_name_en}} @endif
Product Details
@endsection
@section('content')
                    ...
                    <div class="row  wow fadeInUp">
                                ...
                                <div id="owl-single-product">
                                    ...
                                    <div class="single-product-gallery-item" id="slide{{ $item->id }}">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            ...
                                            <img class="img-responsive" alt="" src="{{asset($item->photo_name)}}"
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                <h1 class="name" id="pname">@if(session()->get('language') == 'urdu')
                                    {{ $product->product_name_ur }} @else {{ $product->product_name_en}} @endif </h1>
                                ...
                                <div class="description-container m-t-20">
                                    @if(session()->get('language') == 'urdu')
                                    {{ $product->short_desc_ur }} @else {{ $product->short_desc_en}} @endif
                                ...
                                <div class="price-container info-container m-t-20">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="color" class="form-control unicase-form-control selectpicker"
                                                    ...
                                                    @foreach($product_color_ur as $item)
                                                    <option>{{ ucwords($item) }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                @if($product->product_size_en == null || $product->product_size_ur ==
                                                null)
                                                ...
                                                <select id="size" class="form-control unicase-form-control selectpicker"
                                                    ...
                                                    @foreach($product_size_ur as $item)
                                                    <option>{{$item}}</option>
                                                    @endforeach
                            ...
                            <div class="tab-content">
                                ...
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">@if(session()->get('language') == 'urdu')
                                            {!! $product->long_desc_ur !!} @else {!! $product->long_desc_en !!} @endif
                                        </p>
                                    </div>
                                </div><!-- /.tab-pane -->
