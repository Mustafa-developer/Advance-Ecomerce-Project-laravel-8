                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading"> <a href="#collapse{{ $category->id }}"
                                                ...
                                                {{ $category->category_name_ur}} @else {{ $category->category_name_en}}
                                                @endif
                                            </a> </div>
                                        <!-- /.accordion-heading -->
                    ...
                    <div id="myTabContent" class="tab-content category-list">
                        <div class="tab-pane active " id="grid-container">
                            <div class="category-product">
                                <div class="row">
                                    @forelse($subsubcategory_products as $item)
                                            ...
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="{{ url('product/detail/'.$item->id.'/'.$item->product_slug_en) }}">
                                                        @if(session()->get('language')
                                                            == 'urdu')
                                                            {{ $item->product_name_ur }} @else
                                                            {{  $item->product_name_en }} @endif
                                                    </a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        @if($item->discount_price == NULL)
                                                    <div class="product-price"> <span class="price"> $600.00 </span>
                                                    ...
                                                    @endif
                                                        <!-- /.product-price -->
                                                        <div class="description m-t-10">@if(session()->get('language')
                                                            == 'urdu')
                                                            {{ $item->short_desc_en }} @else
                                                            {{  $item->short_desc_ur }} @endif</div>
                                                        <div class="cart clearfix animate-effect">
                                                            <div class="action">
                                                                <ul class="list-unstyled">
                                                                    <li class="add-cart-button btn-group">
