                        ...
                        <div class="table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> <img src="{{ asset($product->product_thumbnail) }}" alt=""
                                        ...
                                        <td>
                                            ...
                                            @if($product->status == 1)
                                            <span class="badge badge-phill badge-success">Active</span>
                                            @else
                                            <span class="badge badge-phill badge-danger">InActive</span>
                                            @endif
